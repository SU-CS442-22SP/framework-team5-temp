...
def read_training_files(data_path:str):
    ...
    with codecs.open(data_path + '\\train.function','r',encoding='utf-8') as f:
        t_enc = f.readlines()

    with codecs.open(data_path + '\\valid.function','r',encoding='utf-8') as f:
        v_enc = f.readlines()

    # combine train and validation and let keras split it randomly for you
    tv_enc = t_enc + v_enc

    with codecs.open(data_path + '\\test.function','r',encoding='utf-8') as f:
        h_enc = f.readlines()

    with codecs.open(data_path + '\\train.docstring','r',encoding='utf-8') as f:
        t_dec = f.readlines()

    with codecs.open(data_path + '\\valid.docstring','r',encoding='utf-8') as f:
        v_dec = f.readlines()

    # combine train and validation and let keras split it randomly for you
    tv_dec = t_dec + v_dec

    with codecs.open(data_path + '\\test.docstring','r',encoding='utf-8') as f:
        h_dec = f.readlines()
